...
const char * const BITCOIN_CONF_FILENAME = "sucrecoin.conf";
const char * const BITCOIN_PID_FILENAME = "sucrecoind.pid";
...
void Create_Config(const string& path)
{
	...
	file << "stakegen=1\n";
	file << "rpcuser=username\n";
	file << "rpcpassword=s0m3p45w0rd\n";
    file << "port=2102\n";
    file << "rpcport=2103\n";
	file << "rpcallowip=127.0.0.1\n";
	file << "addnode=dev1.sucrecoin.org\n";
	file << "addnode=dev2.sucrecoin.org\n";
    file << "addnode=dev3.sucrecoin.org\n";
    file << "addnode=dev4.sucrecoin.org\n";
    file << "addnode=dev5.sucrecoin.org\n";
    file << "addnode=dev6.sucrecoin.org\n";
